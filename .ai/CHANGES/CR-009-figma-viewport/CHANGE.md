...
- [ ] T-001: 中央视口重构（R-023 四角元数据 + R-025 滚轮/滑条同步；去除中央元数据表格）
- [ ] T-002: 顶部工具（R-024：pan/zoom/window/rotate/measure + W/L 预设读数；测量迁移）
- [ ] T-003: 图片查看器工具 + 左右抽屉动画（R-024 子集 + R-026）
- [ ] T-004: 矩阵与走查（R-023~R-026 断言 + E2E 更新 + 文档）
