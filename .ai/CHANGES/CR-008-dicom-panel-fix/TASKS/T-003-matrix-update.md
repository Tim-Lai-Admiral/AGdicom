...
- **Commit / PR**：commit `ecaf240`（test）、`2cd1f76`（docs result）；分支 `feature/CR-008-T-003-matrix-update`（含 T-001/T-002 提交）；PR #39（https://github.com/Tim-Lai-Admiral/AGdicom/pull/39，base master；**按序合并：#37（T-001）→ #38（T-002）→ 本 PR**）
